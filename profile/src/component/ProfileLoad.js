...
class ProfileLoad extends React.PureComponent {
  constructor(props) {
    super(props);
    this.state = { userName: 'hello', loading: true };
  }
  ...
  render() {
    ...
    return (
      <Router>
        <NavBar data={{ username: this.state.userName }} />
        <div style={{ maxWidth: '800px', margin: '0px auto' }}>
          ...
          >
            ...
            <div>
              ...
              <div>
                <Link to={'/password/Change'} data-testid="changePass">
                  <button>Change Password</button>
                </Link>
              </div>
              <div>
                <Link to={'/account/Delete'} data-testid="deleteAcc">
          ...
          <article>
            <Route path="/password/Change" render={() => <PasswordC />} />
            <Route path="/account/Delete" render={() => <DeleteAccount />} />
            {/* <Route path={'/'+this.state.userName+'message'} render={() => <message />} /> */}
          </article>
        </div>
      </Router>
    );
